...
export default function About() {
  return (
    <div className="flex md:flex-row flex-col md:gap-0  gap-8 items-center  mt-20">
      <img src={about} alt="about" />
      <div className="md:pl-20 md:px-0 px-5 text-white ">
        <h6>About DEFI AI</h6>
        <h2 className="text-[38px] leading-[45px] mt-2">
          Unlock the Future: <br className="md:block hidden " /> Experience the
          Power Of <br className="md:block hidden " /> Our Web3 Platform
        </h2>
